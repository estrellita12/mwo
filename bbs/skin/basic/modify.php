...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<td>
			...
			<a href="<?php echo TB_DATA_URL.'/board/'.$boardid.'/'.$write['fileurl1']; ?>" target="_blank"><span class="bold fc_255"><?php echo $write['fileurl1']; ?></span></a>
	...
	<tr>
		...
		<td>
			...
			<a href="<?php echo TB_DATA_URL.'/board/'.$boardid.'/'.$write['fileurl2']; ?>" target="_blank"><span class="bold fc_255"><?php echo $write['fileurl2']; ?></span></a>
