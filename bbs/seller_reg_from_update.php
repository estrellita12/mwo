...
$value['goods_link']            = $_POST['goods_link'];
...
//alert('정상적으로 신청 되었습니다.', TB_BBS_URL.'/seller_reg_from.php');
alert(' 정상적으로 신청 되었습니다.\\n 담당MD의 검토 후 계약이 체결될 예정입니다.\\n 2~3일이 소요될 수 있습니다. ', '/index.php');
?>
