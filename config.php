...
define('TB_SMTP',        'smtp.gmail.com');
define('TB_SMTP_PORT',              '587');
define('TB_SMTP_SECURE',            'TLS');
define('TB_SMTP_USER', 'choimr@majorworld.co.kr');
define('TB_SMTP_PW',        'ldqyvdlzkvbxkcuw');
