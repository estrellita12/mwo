...
// 서버상 bin 폴더 이전까지 경로
$home_dir = TB_KCPCERT_PATH; // ct_cli 절대경로 ( bin 전까지 )
...
if(!$site_cd)
    alert('KCP 휴대폰 본인확인 서비스 사이트코드가 없습니다.\\관리자 > 기본환경설정에 KCP 사이트코드를 입력해 주십시오.', TB_URL);

// KCP 인증 라이브러리
require TB_KCPCERT_PATH.'/lib/ct_cli_lib.php';
