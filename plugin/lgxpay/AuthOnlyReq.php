...
$LGD_RETURNURL  = TB_PLUGIN_URL.'/lgxpay/returnurl.php';
if( TB_IS_MOBILE ){
...
<link rel="stylesheet" href="<?php echo TB_CSS_URL;?>/default.css">
...
<form method="post" name ="LGD_PAYINFO" id="LGD_PAYINFO" action="<?php echo TB_LGXPAY_URL; ?>/AuthOnlyRes.php">
...
<div id="uplus_win" class="new_win mbskin">
    ...
    <p class="up_cmt"><img src="<?php echo TB_LGXPAY_URL; ?>/img/upluslogo.jpg" alt="">LG유플러스에 휴대폰 본인확인 요청 중입니다.</p>
    <div class="up_info">
        <a href="http://pgweb.uplus.co.kr:8080/pg/wmp/Home2009/skill/payment_error_center01.jsp" target="_blank"><img src="<?php echo TB_LGXPAY_URL; ?>/img/btn_gouplus.jpg" alt="U+ 오류 해결방법 바로가기"></a>
        <p>본인확인이 진행되지 않는다면<br /> 왼쪽의 링크로 이동하여보세요.</p>
        <!--[If lte IE 7]><span style="clear:both; display:block; content:'';"></span><![endif]-->
    </div>
    <div class="win_btn">
        <button type="button" onclick="window.close();" class="btn_medium">창닫기</button>
    </div>
</div>
<script>
