...
$configPath = TB_LGXPAY_PATH.'/lgdacom'; //LG유플러스에서 제공한 환경파일("/conf/lgdacom.conf,/conf/mall.conf") 위치 지정.
...
if ($xpay->TX()) {
    ...
    */
    ...
    if( "0000" == $xpay->Response_Code() ) {
        ...
        // 성인인증결과
        $adult_day = date("Ymd", strtotime("-19 years", TB_SERVER_TIME));
        ...
        // 인증내역기록
        @insert_cert_history($member['id'], 'lg', 'hp');
...
jQuery(function($) {
    ...
    if (typeof tb_is_mobile != "undefined" && tb_is_mobile ) {
