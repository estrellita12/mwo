...
var category_add = function()
{
    ...
    if(sel_value) {
        /*
        // 2023-02-01 카테고리 확장하며 연결되지 않은 카테고리 예외처리
        var depth1 = sel_value.substr(0,3);
        if( depth1!="001" && depth1!="002" && depth1!="003" ){
            alert("해당 카테고리는 현재 동작하지 않습니다.");
            return;
        }
        */
