...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td><a href="./seller_odr_delivery_excel.php" class="btn_small bx-blue"><i class="fa fa-download"></i> 배송준비 주문내역 다운로드</a></td>
	</tr>
	<tr>
...
<div class="information">
	...
	<div class="content">
		<div class="desc02">
			...
			<p>ㆍ엑셀파일을 저장하실 때는 <strong class="fc_red">Excel 97 - 2003 통합문서 (*.xls)</strong> 로 저장하셔야 합니다.</p>
			...
			<p>ㆍ엑셀데이터는 <strong class="fc_red">2번째 라인부터 저장되므로 타이틀은 지우시면 안됩니다.</strong></p>
		</div>
	 </div>
</div>
...
function forderdelivery_submit(f)
{
	...
	f.action = "./page.php?code=seller_odr_delivery_update";
	return true;
}
</script>
<?php
