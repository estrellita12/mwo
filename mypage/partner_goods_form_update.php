...
if($w == "")
    goto_url(TB_MYPAGE_URL."/page.php?code=partner_goods_form&w=u&gs_id=$gs_id");
else if($w == "u")
    goto_url(TB_MYPAGE_URL."/page.php?code=partner_goods_form&w=u&gs_id=$gs_id$q1&page=$page&bak=$bak");
?>
