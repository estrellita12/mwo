...
$sql_search = " where b.mb_id = '{$seller['seller_code']}' ";
...
if(isset($q_state) && is_numeric($q_state))
	$sql_search .= " and b.shop_state = '$q_state' ";
...
$sql = " select a.*, b.simg1, b.gcode, b.gname, b.mb_id, b.shop_state
...
<form name="foptionlist" id="foptionlist" method="post" action="./seller_goods_list_update.php">
...
<div class="tbl_head02">
	...
	<tr class="rows">
		<th scope="col"><?php echo subject_sort_link('b.shop_state',$q2); ?>승인상태</a></th>
		<th scope="col">업체명</th>
