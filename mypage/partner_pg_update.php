...
$value['de_nicepay_mid']		= $_POST['de_nicepay_mid']; // 나이스페이 상점아이디
$value['de_nicepay_key']		= $_POST['de_nicepay_key']; // 나이스페이 상점서명키
$value['de_nicepay_pwd']		= $_POST['de_nicepay_pwd']; // 나이스페이 취소패스워드
update("shop_partner",$value,"where mb_id='$member[id]'");

goto_url(TB_MYPAGE_URL.'/page.php?code=partner_pg');
?>