...
if(!$config['pf_auth_sms'])
	alert('개별 문자설정 권한이 있어야만 이용 가능합니다.');

$pg_title = "SMS 문자설정";
include_once("./admin_head.sub.php");

$sms = get_sms($member['id']);
...
if(!$sms) {
	...
	$sms['cf_sms_type'] = 'SMS';
	$sms['cf_sms_recall'] = '';
	$sms['cf_icode_server_ip'] = '';
	$sms['cf_icode_server_port'] = '';
    $sms['cf_icode_id'] = '';
	$sms['cf_icode_pw'] = '';
	$sms['cf_cont1'] = $adm['cf_cont1'];
	$sms['cf_cont2'] = $adm['cf_cont2'];
	$sms['cf_cont3'] = $adm['cf_cont3'];
	$sms['cf_cont4'] = $adm['cf_cont4'];
	$sms['cf_cont5'] = $adm['cf_cont5'];
	$sms['cf_cont6'] = $adm['cf_cont6'];
	$sms['cf_mb_use1'] = $adm['cf_mb_use1'];
	$sms['cf_ad_use1'] = $adm['cf_ad_use1'];
	$sms['cf_re_use1'] = $adm['cf_re_use1'];
	$sms['cf_sr_use1'] = $adm['cf_sr_use1'];
	$sms['cf_mb_use2'] = $adm['cf_mb_use2'];
	$sms['cf_ad_use2'] = $adm['cf_ad_use2'];
	$sms['cf_re_use2'] = $adm['cf_re_use2'];
	$sms['cf_sr_use2'] = $adm['cf_sr_use2'];
	$sms['cf_mb_use3'] = $adm['cf_mb_use3'];
	$sms['cf_ad_use3'] = $adm['cf_ad_use3'];
	$sms['cf_re_use3'] = $adm['cf_re_use3'];
	$sms['cf_sr_use3'] = $adm['cf_sr_use3'];
	$sms['cf_mb_use4'] = $adm['cf_mb_use4'];
	$sms['cf_ad_use4'] = $adm['cf_ad_use4'];
	$sms['cf_re_use4'] = $adm['cf_re_use4'];
	$sms['cf_sr_use4'] = $adm['cf_sr_use4'];
	$sms['cf_mb_use5'] = $adm['cf_mb_use5'];
	$sms['cf_ad_use5'] = $adm['cf_ad_use5'];
	$sms['cf_re_use5'] = $adm['cf_re_use5'];
	$sms['cf_sr_use5'] = $adm['cf_sr_use5'];
	$sms['cf_mb_use6'] = $adm['cf_mb_use6'];
	$sms['cf_ad_use6'] = $adm['cf_ad_use6'];
	$sms['cf_re_use6'] = $adm['cf_re_use6'];
	$sms['cf_sr_use6'] = $adm['cf_sr_use6'];
}
...
<form name="fconfig" id="fconfig" action="./partner_sms_update.php" method="post">
