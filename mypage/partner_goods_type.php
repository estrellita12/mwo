...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<?php echo check_checked('q_type1', $q_type1, '1', $default['de_pname_1']); ?>
			<?php echo check_checked('q_type2', $q_type2, '1', $default['de_pname_2']); ?>
			<?php echo check_checked('q_type3', $q_type3, '1', $default['de_pname_3']); ?>
			<?php echo check_checked('q_type4', $q_type4, '1', $default['de_pname_4']); ?>
			<?php echo check_checked('q_type5', $q_type5, '1', $default['de_pname_5']); ?>
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col" class="th_bg"><?php echo $default['de_pname_1']; ?></th>
		<th scope="col" class="th_bg"><?php echo $default['de_pname_2']; ?></th>
		<th scope="col" class="th_bg"><?php echo $default['de_pname_3']; ?></th>
		<th scope="col" class="th_bg"><?php echo $default['de_pname_4']; ?></th>
		<th scope="col" class="th_bg"><?php echo $default['de_pname_5']; ?></th>
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		$gs_id = $row['index_no'];
		$href = TB_SHOP_URL.'/view.php?index_no='.$gs_id;
