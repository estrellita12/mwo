...
$sql = " select * from shop_order where dan = '3' and seller_id='{$seller['seller_code']}' order by od_time desc, index_no asc ";
...
$TD_COLOR = array(
    ...
    'fill' => array(
        ...
        'color' => array('rgb'=>'ffef2f'),
    ),

);
$excel->getActiveSheet()->getStyle("M1:N1")->applyFromArray($TD_COLOR);
$excel->getActiveSheet()->getColumnDimension('L')->setWidth(80);
