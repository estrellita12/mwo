...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td>
			<a href="<?php echo TB_LIB_URL; ?>/Excel/itemexcel2.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a>
			<a href="<?php echo TB_ADMIN_URL; ?>/category/category_excel.php" class="btn_small bx-white"><i class="fa fa-file-excel-o"></i> 카테고리 엑셀다운로드</a>
		</td>
	</tr>
	<tr>
