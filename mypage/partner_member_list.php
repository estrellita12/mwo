...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$formmail = "<a href=\"".TB_ADMIN_URL."/formmail.php?mb_id=".$row['id']."&name=".urlencode($row['name'])."&email=".$email."\" onclick=\"win_open(this,'win_email','650','580','no'); return false;\" class=\"btn_small\">메일</a>\n";
