...
if($w == '') {
	...
	goto_url(TB_MYPAGE_URL."/page.php?code=partner_goods_plan_form&w=u&pl_no=$pl_no");

} else if($w == 'u') {
	update("shop_goods_plan", $value, "where pl_no='$pl_no'");

	goto_url(TB_MYPAGE_URL."/page.php?code=partner_goods_plan_form&w=u&pl_no=$pl_no$qstr&page=$page");
}
?>