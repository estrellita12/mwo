...
if($w == "u" && $bak) {
	...
	$frm_submit .= '<a href="./page.php?code=partner_goods_form" class="btn_large bx-red">추가</a>'.PHP_EOL;
}
$frm_submit .= '</div>';
...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td>
			...
			<a href="./page.php?code=partner_baesong" target="_blank" class="btn_small grey">설정</a>
