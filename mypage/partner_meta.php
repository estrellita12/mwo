...
<form name="fregform" method="post" action="./partner_meta_update.php">
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<input type="text" name="head_title" value="<?php echo $partner['head_title']; ?>" class="frm_input" size="60">
	...
	<tr>
		...
		<td>
			<input type="text" name="meta_author" value="<?php echo $partner['meta_author']; ?>" class="frm_input" size="60">
	...
	<tr>
		...
		<td>
			<input type="text" name="meta_description" value="<?php echo $partner['meta_description']; ?>" class="frm_input" size="60">
