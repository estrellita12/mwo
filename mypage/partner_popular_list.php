...
$sql_search = " where pt_id = '{$member['id']}' and TRIM(pp_word) <> '' ";
...
<form name="fpopularlist" id="fpopularlist" method="post" action="./partner_popular_list_delete.php" onsubmit="return fpopularlist_submit(this);">
