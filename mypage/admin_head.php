...
<div id="header"<?php if($admin_seller) { ?> class="supply"<?php } ?>>
	...
	<div id="tnb">
		<ul>
			...
			<li><a href="<?php echo TB_MYPAGE_URL; ?>/page.php?code=seller_main">어드민홈</a></li>
			<?php } ?>
