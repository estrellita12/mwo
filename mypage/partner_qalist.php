...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<select name="sfl">
				<?php echo option_selected('mb_id', $sfl, '작성자ID'); ?>
...
<form name="fqalist" id="fqalist" method="post" action="./partner_qalist_delete.php" onsubmit="return fqalist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		$s_upd = "<a href=\"./page.php?code=partner_qaform&w=u&index_no={$row['index_no']}$qstr&page=$page\" class=\"btn_small\">수정</a>";
