...
<a href="./page.php?code=seller_odr_delivery" class="btn_lsmall"><i class="fa fa-upload"></i> 엑셀배송처리</a>
EOF;
?>
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td class="td_imgline"><a href="<?php echo TB_SHOP_URL; ?>/view.php?index_no=<?php echo $row2['gs_id']; ?>" target="_blank"><?php echo get_it_image($row['gs_id'], $gs['simg1'], 30, 30); ?></a></td>
