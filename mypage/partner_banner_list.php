...
$sql_search = " where bn_device = 'pc' and bn_theme = '{$member['theme']}' and mb_id = '{$member['id']}' ";
...
<a href="./partner_banner_list_update.php?mod_type=R" class="btn_lsmall bx-red" onclick="return default_confirm(this, '');"><i class="fa fa-refresh fa-spin"></i> 본사와 동일하게 설정값 초기화</a>
...
<form name="fbannerlist" id="fbannerlist" method="post" action="./partner_banner_list_update.php" onsubmit="return fbannerlist_submit(this);">
<input type="hidden" name="q1" value="<?php echo $q1; ?>">
<input type="hidden" name="page" value="<?php echo $page; ?>">

<h2>PC스킨 (<?php echo $member['theme']; ?>) 배너목록</h2>
<div class="local_ov">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$s_upd = "<a href='./page.php?code=partner_banner_form&w=u&bn_id=$bn_id$qstr&page=$page' class=\"btn_small\">수정</a>";
