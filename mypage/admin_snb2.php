...
$sqCnt   = sel_count("shop_qa", "where result_yes = '0' and pt_id = '{$member['id']}'");
...
<dl>
	...
	<?php echo printMenu2(1, '고객 1:1상담문의', asideUrl.'?code=partner_qalist', $sqCnt); ?>
	...
	<?php echo printMenu2(3, '스킨관리_skin1', asideUrl.'?code=partner_skin1_form'); ?>
	...
	<?php echo printMenu2(7, '결제완료', asideUrl.'?code=partner_odr_2', $sodr2['cnt']); ?>
    ...
    <?php echo printMenu1(8, '교환 관리'); ?>
    <?php echo printMenu2(8, '교환신청', asideUrl.'?code=partner_odr_12', $sodr12['cnt']); ?>
    <?php echo printMenu2(8, '교환중', asideUrl.'?code=partner_odr_13', $sodr13['cnt']); ?>
    <?php echo printMenu2(8, '교환완료', asideUrl.'?code=partner_odr_8', $sodr8['cnt']); ?>
    <?php echo printMenu1(9, '반품 관리'); ?>
    <?php echo printMenu2(9, '반품신청', asideUrl.'?code=partner_odr_10', $sodr10['cnt']); ?>
    <?php echo printMenu2(9, '반품중', asideUrl.'?code=partner_odr_11', $sodr11['cnt']); ?>
    <?php echo printMenu2(9, '반품완료', asideUrl.'?code=partner_odr_7', $sodr7['cnt']); ?>
    <?php echo printMenu1(10, '취소/환불 관리'); ?>
    <?php echo printMenu2(10, '입금전 취소', asideUrl.'?code=partner_odr_6', $sodr6['cnt']); ?>
    <?php echo printMenu2(10, '배송전 환불', asideUrl.'?code=partner_odr_9', $sodr9['cnt']); ?>
	<?php echo printMenu1(11, '수수료 리포트'); ?>
	<?php echo printMenu2(11, '수수료 정산', asideUrl.'?code=partner_paylist'); ?>
	<?php echo printMenu2(11, '수수료 건별내역', asideUrl.'?code=partner_payhistory'); ?>
