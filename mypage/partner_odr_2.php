...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="<?php echo $rowspan; ?>">
			<a href="<?php echo TB_MYPAGE_URL; ?>/partner_odr_form.php?od_id=<?php echo $row['od_id']; ?>" onclick="win_open(this,'partner_odr_form','1200','800','yes');return false;" class="fc_197"><?php echo $row['od_id']; ?></a>
		...
		<td class="td_itname"><a href="<?php echo TB_MYPAGE_URL; ?>/page.php?code=partner_goods_form&w=u&gs_id=<?php echo $row2['gs_id']; ?>" target="_blank"><?php echo get_text($gs['gname']); ?></a></td>
		<?php if($k == 0) { ?>
		<td rowspan="<?php echo $rowspan; ?>">
...
<div class="information">
	...
	<div class="content">
		...
		<div class="desc01 accent">
			<p>ㆍ주문리스트 내 선택된 주문의 상태를 <em>"결제완료 &gt; 배송준비 &gt; 배송중 &gt; 배송완료 &gt; 구매확정"</em> 순으로 변경됩니다.</p>
		...
		<div class="hd">ㆍ결제완료 상태에서 입금대기 상태로 변경할 수 있나요?</div>
		<div class="desc01 accent">
			<p>ㆍ주문리스트에서 결제완료 상태의 주문을 "입금대기" 상태로 변경할 수 없습니다.</p>
			<p>ㆍ결제완료 상태에서 입금대기 상태로 변경은 해당 주문의 <strong>"주문상세정보"</strong> 페이지에서만 가능합니다.</p>
		</div>
	 </div>
</div>
