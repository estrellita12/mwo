...
<form name="fqaform" method="post" action="./partner_qaform_update.php">
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td><input type="text" name="replyer" value="<?php echo $qa['replyer']; ?>" required class="frm_input required"></td>
	</tr>
	<tr>
...
<div class="btn_confirm">
	...
	<a href="./page.php?code=partner_qalist<?php echo $qstr; ?>&page=<?php echo $page; ?>" class="btn_large bx-white">목록</a>
</div>
</form>
