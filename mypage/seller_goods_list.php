	...
	<tr>
		...
		<td colspan="3">
			<select name="sfl">
				...
				<?php echo option_selected('index_no', $sfl, '상품번호(사방넷)'); ?>
...
<div class="tbl_head02">
	...
	<tr>
		...
		<th scope="col" rowspan="2"><?php echo subject_sort_link('shop_state',$q2); ?>승인상태</a></th>
	...
	<tr class="rows">
		<th scope="col"><?php echo subject_sort_link('index_no',$q2); ?>상품번호(사방넷)</a></th>
		<th scope="col">업체명</th>
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2" class="fc_00f"><?php echo $gw_state[$row['shop_state']]; ?></td>
	...
	<tr class="<?php echo $bg; ?>">
		<td class=""><?php echo $row['index_no']; ?></td>
