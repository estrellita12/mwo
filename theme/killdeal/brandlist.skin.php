...
$qstr1 = 'br_name='.$br_name.'&?br_id='.$br_id.'&page_rows='.$page_rows.'&sort='.$sort.'&sortodr='.$sortodr;
$qstr2 = 'br_name='.$br_name.'&?br_id='.$br_id.'&page_rows='.$page_rows;
$qstr3 = 'br_name='.$br_name.'&?br_id='.$br_id.'&sort='.$sort.'&sortodr='.$sortodr;
...
<h2 class="pg_tit">
	<span><?php echo $default['de_pname_6']; ?></span>
	<p class="pg_nav">HOME<i>&gt;</i><?php echo $default['de_pname_6']; ?><i>&gt;</i><?php echo $tb['title']; ?></p>
</h2>

<h2 class="br_view_tit">
	<span class="tit_txt"><?php echo $tb['title']; ?></span>
    <?php if($br_logo !=  TB_IMG_URL.'/brlogo_sam.jpg' ){ ?>
