...
<p class="subpg_nav">홈<i class="ionicons ion-ios-arrow-right"></i><?php echo $default['de_pname_6']; ?></p>

<h2 class="pg_tit subpg_tit">
	<?php echo $default['de_pname_6']; ?>
	<span>각 <?php echo $default['de_pname_6']; ?>의 상품들을 모아모아서 쇼핑하기!</span>
</h2>
