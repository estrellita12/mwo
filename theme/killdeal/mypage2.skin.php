	...
	<div id="smb_my_ov">
		...
		<div id="smb_my_act">
			<ul>
			    ...
			    <? if($pt_id == 'golfpang') // 골팡_20190920
				   {
			    ?>
				      <li><a href="http://www.golfpang.com/web/mymembers/mypage.do" class="btn_lsmall">회원정보수정</a></li>
				      <!-- <li><a href="<?php echo TB_BBS_URL; ?>/leave_form.php" class="btn_lsmall grey">회원탈퇴</a></li> -->
			    <? }
			       else
				   {
			    ?>
			      	 <li><a href="<?php echo TB_BBS_URL; ?>/member_confirm.php?url=register_form.php" class="btn_lsmall">회원정보수정</a></li>
				     <li><a href="<?php echo TB_BBS_URL; ?>/leave_form.php" class="btn_lsmall grey">회원탈퇴</a></li>
			    <? } ?>
			</ul>
		</div>
...
<!-- 		</tr> -->
	...
	<div id="smb_my_od">
		...
		<div class="tbl_head02 tbl_wrap">
			...
			<tr>
				<td class="tac" rowspan="<?php echo $rowspan; ?>">
					...
					<p class="padt5"><a href="<?php echo TB_SHOP_URL; ?>/orderinquiryview.php?od_id=<?php echo $od['od_id']; ?>" class="btn_small grey">상세보기</a></p>
				</td>
			</tr>
			<?php } ?>
			<tr class="rows">
					...
					<div class="ini_wrap">
						...
						<tr>
							...
							<td class="vat tal">
								...
								<?php if($od['dan'] == 5) { ?>
								<p class="padt3"><a href="<?php echo TB_SHOP_URL; ?>/orderreview.php?gs_id=<?php echo $od['gs_id']; ?>&od_id=<?php echo $od['od_id']; ?>" onclick="win_open(this, 'winorderreview', '650', '530','yes');return false;" class="btn_ssmall bx-white">구매후기 작성</a></p>
								<?php } ?>
							</td>
						</tr>
						</table>
				...
				<td class="tar">
				 <?php 
				        if($pt_id =='golf'){ //현대리바트(기본금을 결제금액에 반영)
				                echo display_price($od['use_price'] + $od['use_point2']);
								 
				        
			            }else{
				                echo display_price($od['use_price']);
						}
			     ?>
				</td>
				<td class="tac">
		...
		<div class="smb_my_more">
			<a href="<?php echo TB_SHOP_URL; ?>/orderinquiry2.php" class="btn_lsmall bx-white">주문내역 더보기</a>
		</div>
	</div>
	<!-- } 최근 주문내역 끝 -->
	...
	<div id="smb_my_wish">
		...
		<div class="smb_my_more">
			<a href="<?php echo TB_SHOP_URL; ?>/wish.php" class="btn_lsmall bx-white">찜한상품 더보기</a>
		</div>
	</div>
	<!-- } 최근 찜한상품 끝 -->
