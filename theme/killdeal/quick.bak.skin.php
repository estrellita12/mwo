...
/*
//킬딜특가상품 조회
$test_deal = get_kill_deal_pro($result);

// 테이블의 전체 레코드수만 얻음
$sql = " select count(*) as cnt $test_deal ";
$row = sql_fetch($sql);
$total_count = $row['cnt'];

$sql = " select * $test_deal ";
$result = sql_query($sql);
*/
...
?>
            ...
            <a href="<?php echo $it_href; ?>">
                ...
                <span class="price"><span class="price_box ">회원가 보기</span></span>
            </a>
<?php
}
if(!$i)
...
?>
        ...
        <div class="stv_wrap wsetbg">
            <span id="prev">&lt;</span><span id="stv_pg"></span><span id="next">&gt;</span>
        </div>
        <?php } ?>
    </div>
