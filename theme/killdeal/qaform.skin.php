...
<div id="sit_qa_write" class="new_win">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			<th scope="row">성명</th>
			<td><label><input type="text" name="iq_name" value="<?php echo $iq_name; ?>" required itemname="성명" class="frm_input required" size="20"></label></td>
		</tr>
		<tr>
			<th scope="row">이메일</th>
			<td><label><input type="text" name="iq_email" value="<?php echo $iq_email; ?>" required email itemname="이메일" class="frm_input required" size="30"></label></td>
		</tr>
		<tr>
			<th scope="row">핸드폰</th>
			<td><label><input type="text" name="iq_hp" value="<?php echo $iq_hp; ?>" required itemname="핸드폰" class="frm_input required" size="20"></label></td>
		</tr>
		<tr>
			<th scope="row">제목</th>
			<td><label><input type="text" name="iq_subject" value="<?php echo $iq_subject; ?>" required itemname="제목" class="frm_input wfull required"></label></td>
		</tr>
		<tr>
			<th scope="row">질문</th>
			<td><label><textarea name="iq_question" rows="10" required itemname="질문" class="frm_textbox wufll required"><?php echo $iq_question; ?></textarea></label></td>
		</tr>
		</tbody>
		</table>
	</div>
