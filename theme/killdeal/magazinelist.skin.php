...
$sql = "update shop_goods_magazine set mgz_hit = $hitcnt+1 {$sql_where} ";
$result = sql_query($sql);

$qstr1 = 'mgz_no='.$mgz_no.'&page_rows='.$page_rows.'&sort='.$sort.'&sortodr='.$sortodr;
$qstr2 = 'mgz_no='.$mgz_no.'&page_rows='.$page_rows;
$qstr3 = 'mgz_no='.$mgz_no.'&sort='.$sort.'&sortodr='.$sortodr;
...
<h2 class="pg_tit">
	...
	<p class="pg_nav">HOME<i>&gt;</i><?php echo $default['de_pname_9']; ?></p>
	<p class="plan_hit"><?php echo $pl['mgz_hit']; ?> 읽음</p>
</h2>
