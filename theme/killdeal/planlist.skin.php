...
?>
<!-- 20200414 주석 style.css에 css로추가 -->
<!-- <style>
.img_wfull img { width: 100%; height: auto; }
</style> -->

<h2 class="pg_tit">
	<span><?php if($pl['pl_no'] != '120') {echo $tb['title'];} ?></span>
	<span class="pg_nav">HOME<i>&gt;</i><?php echo $default['de_pname_7']; ?></span>
</h2>
...
<?php 
	if($pl['pl_no'] != '120') {
		if($bimg_url) { 
?>
<p class="marb10"><img src="<?php echo $bimg_url; ?>" width="1400" style="display:block; margin:0 auto;"></p>
<?php } ?>

<div class="ofh tac padt10 padb10 planlist_img">
	<?php echo get_view_thumbnail(conv_content($pl['pl_memo'], 1), 1000); ?>
</div>
<div class="tab_sort">
