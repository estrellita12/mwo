...
<div class="tbl_head02 tbl_wrap">
	...
	<tr>
		<td class="tar" colspan="7">
			...
			기본금결제 : <strong><?php echo display_price($stotal['usepoint2']); ?></strong>) =
			총계 : <strong class="fc_red"><?php echo display_price($stotal['useprice']); ?></strong>
			</br>사용한 포인트<strong class="fc_red"><?php echo($stotal['usepoint']); ?></strong>
			적립될 포인트 : <strong class="fc_red"><?php echo $stotal['point'];; ?></strong>
		</td>
	</tr>
	</tfoot>
	</table>
...
<!--    <a href="<?php echo TB_URL; ?>" class="btn_large bx-white">취소</a> -->
	<a id="censel_sel" href="#" class="btn_large bx-white">취소</a>  
</div>
...
<!-- 모달창 -->
  <div id="myModal" class="modal">
   <div id="modal_pop" class="modal-content">
  	<div class="modal_cont_wrap">
  		<p class="modal_text"><span>결제를 취소 하시겠습니까?</span></p>
  		<div class="modal_btn_wrap">
			<a class="btn_medium modal_btn btn_yes" href="<?php echo TB_URL ?>"><strong>예</strong></a>
  			<button class="modal_btn btn_no" onClick="close_pop()" ><strong>아니오</strong></button>
  		</div>
  	</div>
  	 <!--  <div style="cursor:pointer;background-color:#454545; color:#ffff; text-align: center;padding-bottom: 10px;padding-top: 10px;" onClick="close_pop();">
