...
<!-- 이니시스 결제 시작 { -->
<p><img src="<?php echo TB_IMG_URL; ?>/orderform.gif" alt="주문/결제 과정 이미지"></p>
...
<form name="forderform" id="forderform" method="post" autocomplete="off">
  	...
  	<div class="modal_cont_wrap">
  		...
  		<div class="modal_btn_wrap">
		 	...
		 	<a class="btn_medium modal_btn btn_yes" href="<?php echo TB_URL ?>"><strong>예</strong></a>
  			<button class="btn_medium modal_btn btn_no" onclick="close_pop()"><strong>아니오</strong></button>
  		</div>
  	</div>
  	   </div>
   </div>
