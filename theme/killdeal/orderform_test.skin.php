            ...
            <table>
               ...
               -->
                    ...
                    <tr>
                        ...
                        <td>
                            <p>전자금융거래법에 따라 금융감독(원) 위원회에 결제대금 예치업을 등록하였으며, 안전거래를 위해 구매 금액, 결제수단에 상관없이 모든 거래에 대하여 저희 쇼핑몰에서 가입한 구매안전서비스를 자동으로 적용하고 있습니다.</p>
                        </td>
                    </tr>
                ...
                <tr>
                    <th scope="row">이름</th>
                    <td><label><input type="text" name="name" value="<?php echo $member['name']; ?>" required itemname="이름" class="frm_input required" size="20" onKeyup="NameCheck(this)"></label></td>
                </tr>
                <tr>
                    <th scope="row">휴대폰</th>
    ...
    if($is_member && $config['usepoint_yes']  && $pt_id != 'golf') { ?>
            ...
            <section id="guest_privacy">
                <h3 class="pg_cnt marb15">
                    <strong class="<?php echo $line?>">개인정보 수집 및 이용</strong><?php if(!$is_member) { ?> 비회원으로 주문 시 여러 혜택을 받을 수 없습니다. <?php } ?>
                </h3>
                <div class="tbl_head02 tbl_wrap">
                    <table>
