...
<div class="tbl_frm01 tbl_wrap">
	<table>
		<caption>아이디/비밀번호 입력테이블</caption>
	<colgroup>
		<col class="w140">
		<col>
	</colgroup>
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<input type="text" name="mb_hp" value="<?php echo get_text($member['cellphone']); ?>" id="reg_mb_hp"<?php echo $config['register_req_hp']?' required':''; ?> class="frm_input<?php echo $config['register_req_hp']?' required':''; ?>" onKeyup="PhoneNumberSplit(this);" size="20" maxlength="13">
			<span class="frm_info">
