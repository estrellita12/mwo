...
<tr>
	...
	<td class="tar">
		<a href="<?php echo TB_SHOP_URL; ?>/qaform.php?gs_id=<?php echo $index_no; ?>" onclick="win_open(this,'qaform','500','600','yes');return false" class="btn_lsmall black">상품문의 작성</a>
	</td>
</tr>
</table>
</form>
...
<div class="tbl_head01 tbl_wrap">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$is_secret = false;
		if($row['iq_secret']) {
			$icon_secret = '<img src="'.TB_IMG_URL.'/icon/icon_secret.jpg" alt="비밀글">';
