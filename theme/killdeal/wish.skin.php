...
<div id="con_lf">
	...
	<div class="tbl_head02 tbl_wrap">
		<table>
			<caption>찜한상품목록</caption>
		<colgroup>
		<!-- 20200518주석 찜한상품페이지 주문하기/장바구니/체크박스 제거(찜한상품 목록만 보여줌으로 변경) -->
			<!-- <col width="50"> -->
			<col width="100">
			<col>
			<col width="100">
		...
		<tr>
			<td>
				...
				<a href="<?php echo TB_SHOP_URL; ?>/view.php?index_no=<?php echo $row['gs_id']; ?>"><?php echo get_it_image($row['gs_id'], $row['simg1'], 200, 200); ?></a>
			</td>
			...
			<td class="tac"><a href="<?php echo TB_SHOP_URL; ?>/wishupdate.php?w=d&wi_id=<?php echo $row['wi_id']; ?>" class="btn_small bx-red">삭제</td>
		</tr>
		<?php
		} 
		if($i==0) 
