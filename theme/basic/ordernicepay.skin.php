...
require_once(TB_SHOP_PATH.'/nicepay/orderform.1.php');
?>
...
<form name="payForm" id="payForm" method="post" action="<?php echo $order_action_url; ?>" autocomplete="off">

<?php
// 결제대행사별 코드 include (결제대행사 정보 필드)
require_once(TB_SHOP_PATH.'/nicepay/orderform.2.php');
?>
