...
<div id="intro">
	<div id="int_wrap">
		<div class="lcont">
			<!--<h1><?php echo display_logo(); ?><span class="fs14 vam">메이저월드 유통 관리 사이트</span></h1>-->
            <h1><a href="'.TB_URL.'"><img src="https://mwd.kr/wp-content/uploads/2020/02/majorworld_logo.png"></a></h1>
			<h2 class="tit"><b>MWO 파트너 로그인</b></h2>
			<dl class="int_login">
            ...
            <!--
			<div class="int_btn">
				<a href="<?php echo TB_BBS_URL; ?>/register.php" class="btn_lsmall grey">회원가입</a>
				<a href="<?php echo TB_BBS_URL; ?>/password_lost.php" onclick="win_open(this,'pop_password_lost','500','400','no');return false;" class="btn_lsmall bx-white">아이디/비밀번호 찾기</a>
			</div>
            -->
