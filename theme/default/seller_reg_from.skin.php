...
<div class="fsellerform_term">
	...
	<h2 class="mart20">개인정보 수집 및 이용</h2>
...
<?php if(!$is_member) { ?>
<h3 class="anc_tit mart30">사이트 이용정보 입력</h3>
<div class="tbl_frm01">
	<table class="tablef">
	<colgroup>
		<col class="w140">
	...
	<tr>
		...
		<td><input type="password" name="mb_password" id="reg_mb_password" required itemname="비밀번호" class="required frm_input" size="30" minlength="4" maxlength="20"> 4자 이상의 영문 및 숫자</td>
	</tr>
	<tr>
