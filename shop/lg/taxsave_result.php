...
$LGD_PAYTYPE                = $pay_type; //결제수단 (SC0030:계좌이체, SC0040:가상계좌, SC0100:무통장입금 단독)
$LGD_AMOUNT                 = $order_price; //금액("," 를 제외한 금액을 입력하세요)
$LGD_PRODUCTINFO            = $goods_name; //상품명
$LGD_TID                    = $od_tno; //LG유플러스 거래번호
$LGD_CUSTOM_MERTNAME        = $config['company_name']; //상점명
$LGD_CUSTOM_CEONAME         = $config['company_owner']; //대표자명
$LGD_CUSTOM_BUSINESSNUM     = $config['company_saupja_no']; //사업자등록번호
$LGD_CUSTOM_MERTPHONE       = $config['company_tel']; //상점 전화번호
...
<div id="lg_req_tx" class="new_win">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <button type="button" name="receiptView" class="btn_small" onClick="javascript:showCashReceipts('<?php echo $LGD_MID; ?>','<?php echo $LGD_OID; ?>','<?php echo $od_casseqno; ?>','<?php echo $trade_type; ?>','<?php echo $CST_PLATFROM; ?>');">영수증 확인</button>
