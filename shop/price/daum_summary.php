...
$lt = "<<<";
$gt = ">>>";
$shop_url = TB_SHOP_URL;
$data_url = TB_DATA_URL;

$sql_search = " and SUBSTRING(update_time, 1, 10) = '".TB_TIME_YMD."' ";
...
for($i=0; $row=sql_fetch_array($result); $i++)
{
    ...
    if(substr($row['reg_time'], 0, 10) == TB_TIME_YMD && $row['update_time'] >= $row['reg_time'])
        $class = 'I';
