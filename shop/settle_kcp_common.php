...
if(!$default['de_card_test']) {
    switch ($_SERVER['REMOTE_ADDR']) {
        ...
        default :
            ...
            mailer('경고', $super['email'], $super['email'], '올바르지 않은 접속 보고', "{$_SERVER['SCRIPT_NAME']} 에 {$_SERVER['REMOTE_ADDR']} 이 ".TB_TIME_YMDHIS." 에 접속을 시도하였습니다.\n\n" . $egpcs_str, 2);
            exit;
    }
}
...
<?php
    ...
    //write_log(TB_DATA_PATH."/log/kcp_common.log", print_r($_POST));
