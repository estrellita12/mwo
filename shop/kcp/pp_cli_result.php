...
if(TB_IS_MOBILE) {
	...
	echo '<link rel="stylesheet" href="'.TB_MCSS_URL.'/default.css">'.PHP_EOL;
} else {
    echo '<meta http-equiv="imagetoolbar" content="no">'.PHP_EOL;
    echo '<meta http-equiv="X-UA-Compatible" content="IE=Edge">'.PHP_EOL;
	echo '<link rel="stylesheet" href="'.TB_CSS_URL.'/default.css">'.PHP_EOL;
}
?>
<script>
    //현금영수증 연동 스크립트
    ...
    {
        var receiptWin = "<?php echo TB_CASH_RECEIPT_URL.$default['de_kcp_mid'].'&orderid='.$ordr_idxx.'&bill_yn=Y&authno='; ?>"+auth_no;
