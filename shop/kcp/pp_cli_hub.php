...
include_once(TB_LIB_PATH.'/etc.lib.php');

$sql = " select count(*) as cnt from shop_order where od_id = '{$_POST['ordr_idxx']}' and od_cash = 1 ";
$row = sql_fetch($sql);
if ($row['cnt']) {
...
setlocale(LC_CTYPE, 'ko_KR.euc-kr');
    ...
    //write_log(TB_DATA_PATH."/log/cash.log", $_POST);
...
<?php
    ...
    require_once(TB_SHOP_PATH.'/kcp/pp_cli_hub_lib.php');
