...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td><a href="<?php echo TB_ADMIN_URL; ?>/order/order_delivery_excel.php" class="btn_small bx-blue"><i class="fa fa-download"></i> 배송준비 주문내역 다운로드</a></td>
	</tr>
	<tr>
...
function forderdelivery_submit(f)
{
	...
	f.action = tb_admin_url+"/order.php?code=delivery_update";
	return true;
}
</script>
