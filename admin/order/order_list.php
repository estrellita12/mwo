...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<select name="sfl">
				...
				<?php echo option_selected('od_pwd', $sfl, '쇼핑몰 주문번호'); ?>
    ...
    <!--2022-11-07 공급사 검색조건 추가 (./order_query.php 확인)-->
    <tr>
		<th scope="row">공급사</th>
		<td>
			<select class="smartSelect" name="q_seller">
				<?php
				echo option_selected('', $q_seller, '전체');
				$sql = "select * from shop_seller ";
				$res = sql_query($sql);
				while($row = sql_fetch_array($res)){
					echo option_selected($row['seller_code'], $q_seller, $row['company_name']);
				}
				?>
			</select>
		</td>
	...
	<tr>
		...
		<td>
			<select name="sel_field">
				...
				<?php echo option_selected('receipt_time', $sel_field, "결제완료일"); ?>
	...
	<tr>
		...
		<td>
            ...
            <?php echo radio_checked('od_status', $od_status, '10', $gw_status[10]); ?>
            <?php echo radio_checked('od_status', $od_status, '11', $gw_status[11]); ?>
			<?php echo radio_checked('od_status', $od_status, '7', $gw_status[7]); ?>

            <?php echo radio_checked('od_status', $od_status, '12', $gw_status[12]); ?>
            <?php echo radio_checked('od_status', $od_status, '13', $gw_status[13]); ?>            
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
        ...
        <td class="td_img"><a href="<?php echo TB_SHOP_URL; ?>/view.php?index_no=<?php echo $row2['gs_id']; ?>" target="_blank"><?php echo get_it_image($gs['index_no'], $gs['simg1'], 30, 30); ?></a></td>
		...
		<td rowspan="<?php echo $rowspan; ?>" class="td_price"><?php echo number_format($row2['supply_price']); ?></td>
		<td rowspan="<?php echo $rowspan; ?>"><?php echo $row2['od_ip'] ?></td>
		<?php } ?>
	<?php
		}
	}
