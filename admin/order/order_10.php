...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="<?php echo $rowspan; ?>">
            <?php 
                //echo substr($row['return_date2'],2,14); 
                //console_log(substr($row['return_date2'],2,14));
                //echo substr($row['return_date'],2,14); 
                echo substr($row['rcent_time'],2,14); 
            ?>
        </td>
		<td rowspan="<?php echo $rowspan; ?>">
...
<a href="<?php echo TB_SHOP_URL; ?>/view.php?index_no=<?php echo $row2['gs_id']; ?>" target="_blank"><?php echo get_od_image($row['od_id'], $gs['simg1'], 30, 30); ?></a></td>
