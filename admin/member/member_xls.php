...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td><a href="<?php echo TB_LIB_URL; ?>/Excel/memberexcel.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a></td>
	</tr>
	<tr>
...
function fmemberexcel_submit(f)
{
	...
	f.action = tb_admin_url+"/member.php?code=xls_update";
	return true;
}
</script>
