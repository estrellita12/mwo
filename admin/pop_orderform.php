...
<div id="sodr_pop" class="new_win">
    ...
    <section id="anc_sodr_list">
        ...
        <div class="local_desc02 local_desc">
            ...
            <a href="javascript:win_open('<?php echo TB_ADMIN_URL; ?>/order/order_print.php?od_id=<?php echo $od_id; ?>','order_print','670','600','yes');" class="btn_small blue fr"><i class="fa fa-print"></i> 주문서출력</a><span class="fc_214">|</span>
            쇼핑몰 주문번호 <strong><?php echo $od['od_pwd']?></strong> 
            </p>
        </div>
        ...
        <form name="frmorderform" method="post" action="./pop_orderstatusupdate.php" onsubmit="return form_submit(this);">
                ...
                <table id="sodr_list">
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td class="tal">
                            ...
                            // 배송준비.배송중.배송완료
                            $baesong_run = 0;
                            if(in_array($row['dan'], array(3,4,5,10,11,12,13,7,8))) {
                            $baesong_run++;
                            ?>
                            <div class="frm_info">
            ...
            <div class="btn_list marb20">
                ...
                <input type="submit" name="act_button" value="결제완료" class="btn_lsmall red" onclick="document.pressed=this.value">
                ...
                <?php if($chk_cnt == $chk_count2) { // 모두 결제완료 상태인가? ?>
    ...
    <section id="anc_sodr_pay" class="new_win_desc mart30">
        <h3 class="anc_tit">주문 상태 변경 내역<a href="javascript:win_open('<?php echo TB_ADMIN_URL; ?>/order/order_log.php?od_id=<?php echo $od_id; ?>','order_log','670','400','yes')" class="fr btn_small red">+ CS일반</a></h3>
        <div class="tbl_head01">
            <table id="sodr_list">
                <colgroup>
                    <col class="w40">
                ...
                <section id="anc_sodr_chk" class="compare_left">
                    ...
                    <div class="tbl_frm01">
                        <table>
                            ...
                            <tr>
                                <th scope="row">변경금액 <span style="font-size:10px; font-weight:normal;">(변경시 주문상품금액 및 실결제액이 통합 변경됩니다.)</span></th>
                                <td class="td_price bg0">
                                    <input type="text" name="changePrice" value="<?php echo $amount['price']; ?>" class="frm_input td_price">
                                </td>
                            </tr>                            
                            <tr>
                                <th scope="row" class="fc_197">교환/반품 배송비</th>
                                <td class="td_price fc_197">(+) <input type="text" name="baesong2" value="<?php echo $amount['baesong2']; ?>" class="frm_input td_price fc_197"></td>
                            </tr>
                            <tr>
                                <th scope="row" class="fc_red">부분 취소 금액<br>(정산시 배송중,배송완료 상태값에만 적용)</th>
                                <td class="td_price bg1 fc_red">(-) <input type="text" name="cancel" value="<?php echo $amount['cancel']; ?>" class="td_price fc_red frm_input"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
