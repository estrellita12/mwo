...
<a href="./design.php?code=popup_form" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<form name="fpopuplist" id="fpopuplist" method="post" action="./design/popup_list_update.php" onsubmit="return fpopuplist_submit(this);">
