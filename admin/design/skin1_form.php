...
<form name="fregform" method="post" action="./design/skin1_form_update.php">
...
<div class="tbl_head01">
	...
	<tbody>
	<?php
	$list = unserialize(base64_decode($default['de_skin1_menu']));
	for($i=0; $i<10; $i++) {
	?>
	<tr>
...
<div class="tbl_head01">
	...
	<tr>
		...
		<td class="tal"><input type="text" name="de_pname_1" value="<?php echo $default['de_pname_1']; ?>" class="frm_input" placeholder="쇼핑특가"></td>
	...
	<tr>
		<td class="tal"><input type="text" name="de_pname_2" value="<?php echo $default['de_pname_2']; ?>" class="frm_input" placeholder="베스트셀러"></td>
	...
	<tr>
		<td class="tal"><input type="text" name="de_pname_3" value="<?php echo $default['de_pname_3']; ?>" class="frm_input" placeholder="신상품"></td>
	...
	<tr>
		<td class="tal"><input type="text" name="de_pname_4" value="<?php echo $default['de_pname_4']; ?>" class="frm_input" placeholder="인기상품"></td>
	...
	<tr>
		<td class="tal"><input type="text" name="de_pname_5" value="<?php echo $default['de_pname_5']; ?>" class="frm_input" placeholder="추천상품"></td>
	...
	<tr>
		<td class="tal"><input type="text" name="de_pname_6" value="<?php echo $default['de_pname_6']; ?>" class="frm_input" placeholder="브랜드샵"></td>
	...
	<tr>
		<td class="tal"><input type="text" name="de_pname_7" value="<?php echo $default['de_pname_7']; ?>" class="frm_input" placeholder="기획전"></td>
	...
	<tr>
		<td class="tal"><input type="text" name="de_pname_8" value="<?php echo $default['de_pname_8']; ?>" class="frm_input" placeholder="타임세일"></td>
...
<div class="tbl_head01">
	...
	<tr>
		...
		<td><input type="text" name="de_skin1_name" value="<?php echo $default['de_skin1_name']; ?>" class="frm_input" placeholder="최상위 타이틀명"></td>
		<td></td>
	</tr>
	<?php
	$list = unserialize(base64_decode($default['de_skin1_best']));
	for($i=0; $i<10; $i++) {
	?>
	<tr>
