...
$value['bn_theme']	= $super['mobile_theme'];
...
if($w == "") {
	...
	goto_url(TB_ADMIN_URL."/design.php?code=mbanner_form&w=u&bn_id=$bn_id");
} else if($w == "u") {
	update("shop_banner", $value," where bn_id='$bn_id'");

	goto_url(TB_ADMIN_URL."/design.php?code=mbanner_form&w=u&bn_id=$bn_id$qstr&page=$page");
}
?>