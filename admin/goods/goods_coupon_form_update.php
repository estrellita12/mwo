...
if($w == "") {		
	...
	goto_url(TB_ADMIN_URL."/goods.php?code=coupon_form&w=u&cp_id=$cp_id");

} else if($w == "u") {
	update("shop_coupon",$value,"where cp_id='$cp_id'");	
	goto_url(TB_ADMIN_URL."/goods.php?code=coupon_form&w=u&cp_id=$cp_id$qstr&page=$page");
}
?>