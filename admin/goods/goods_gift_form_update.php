...
if($w == "") {
	...
	goto_url(TB_ADMIN_URL."/goods.php?code=gift_form&w=u&gr_id=$gr_id");
	...
	goto_url(TB_ADMIN_URL."/goods.php?code=gift_form&w=u&gr_id=$gr_id$q1&page=$page");
}
?>