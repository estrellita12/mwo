...
<h2>브랜드 수정</h2>
<form name="fregform" method="post" action="./goods/goods_brand_form_update.php" enctype="MULTIPART/FORM-DATA">
...
<div class="btn_confirm">
	...
	<a href="./goods.php?code=brand_list<?php echo $qstr; ?>&page=<?php echo $page; ?>" class="btn_large bx-white">목록</a>
</div>
</form>
