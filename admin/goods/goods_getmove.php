...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			...
			<script>
			$(function() {
				$("#j_ca1").multi_select_box("#j_ca",5,tb_admin_url+"/ajax.category_select_json.php","=카테고리선택=");
				$("#j_ca2").multi_select_box("#j_ca",5,tb_admin_url+"/ajax.category_select_json.php","=카테고리선택=");
				$("#j_ca3").multi_select_box("#j_ca",5,tb_admin_url+"/ajax.category_select_json.php","=카테고리선택=");
				$("#j_ca4").multi_select_box("#j_ca",5,tb_admin_url+"/ajax.category_select_json.php","=카테고리선택=");
	...
	<tr>
		...
		<td>
			...
			<script>
			$(function() {
				$("#m_ca1").multi_select_box("#m_ca",5,tb_admin_url+"/ajax.category_select_json.php","=카테고리선택=");
				$("#m_ca2").multi_select_box("#m_ca",5,tb_admin_url+"/ajax.category_select_json.php","=카테고리선택=");
				$("#m_ca3").multi_select_box("#m_ca",5,tb_admin_url+"/ajax.category_select_json.php","=카테고리선택=");
				$("#m_ca4").multi_select_box("#m_ca",5,tb_admin_url+"/ajax.category_select_json.php","=카테고리선택=");
