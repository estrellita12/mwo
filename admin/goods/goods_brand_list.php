...
<form name="fbrandlist" id="fbrandlist" method="post" action="./goods/goods_brand_list_update.php" onsubmit="return fbrandlist_submit(this);">
<input type="hidden" name="q1" value="<?php echo $q1; ?>">
<input type="hidden" name="page" value="<?php echo $page; ?>">
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><?php echo $num--; ?></td>
		<td><input type="text" name="br_name[<?php echo $i; ?>]" value="<?php echo$row['br_name']; ?>" class="frm_input"></td>
