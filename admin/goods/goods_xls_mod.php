...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td><a href="<?php echo TB_LIB_URL; ?>/Excel/itemexcel3.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a></td>
	</tr>
	<tr>
...
function fitemexcel_submit(f)
{
	...
	f.action = tb_admin_url+"/goods.php?code=xls_mod_update";
	return true;
}
</script>
