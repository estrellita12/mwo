...
<tr>
	...
	<td class="tac">
		<input type="text" name="opt_stock_qty[]" value="<?php echo $opt_stock_qty; ?>" class="frm_input wfull" maxlength='3'>
	</td>
	<td class="tac">
...
<fieldset>
	...
	<ul class="ofh dib">
		...
		<li class="fl marr15">
			...
			<a href="javascript:opt_unlimited('opt_com_stock', '999');" class="btn_small grey">무제한</a>
		</li>
		<li class="fl marr15">
			...
			<a href="javascript:opt_unlimited('opt_com_noti', '999');" class="btn_small grey">무제한</a>
		</li>
		<li class="fl marr15">
