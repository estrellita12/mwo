	...
	<tr>
		...
		<td>
			...
			<div id="sc_amt" class="padt5">
				...
				<label class="marl10"><input type="radio" name="sc_each_use" value="0" checked="checked">묶음배송가능</label>
				<label><input type="radio" name="sc_each_use" value="1">묶음배송불가</label>
			</div>
...
<div class="information">
	...
	<div class="content">
		<div class="desc02">
			<p>ㆍ<em>[기본설정]</em>  <a href="<?php echo TB_ADMIN_URL; ?>/config.php?code=baesong">환경설정 > 배송/교환/반품 설정</a>에서 적용된값으로 부과됩니다.</p>
...
function js_chk_frm(f2)
{
	...
	addHidden(f, 'sc_each_use', getRadioVal(f2.sc_each_use));
