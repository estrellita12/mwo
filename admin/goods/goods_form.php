...
<div class="tbl_frm02">
	...
	<tr>
		<th scope="row">선택된 카테고리<br><span class="fc_red">(최대 1개까지만 등록)</span></th>
		<td>
...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td>
			<input type="text" name="mb_id" value="<?php echo $gs['mb_id']; ?>" id="mb_id" required itemname="업체코드" class="required frm_input" readonly>
            <!--
			...
			$(function() {
				$("#btn_search_item").click(function() {
					...
					$("#relation").load(
						...
						{ gs_id: "<?php echo $gs_id; ?>", mb_id: mb_id, sca: sca, gname: gname }
					);
				});
...
<div class="tbl_frm02">
	...
	<?php } ?>
    <?php  if(!empty($gs['simg_video'])){  ?>
	<tr class="item_img_fld">
		<th scope="row">동영상</th>
		<td>
            <textarea readonly disabled style="height:30px"><iframe src="<?php echo $gs['simg_video'] ?>" height="100%" style="border:none;width:100% !important;" allow="autoplay; fullscreen"></iframe></textarea>
		</td>
	</tr>
    <?php } ?>
	<tr>
...
$sql ="select * from shop_goods_log  where gs_id = '$gs_id' order by index_no desc limit 10 ";
$result = sql_query($sql);
?>
