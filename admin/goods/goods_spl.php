...
<?php
	...
	for($i=0; $i<$subject_count; $i++) {
		$spl_subject = preg_replace(TB_OPTION_ID_FILTER, '', trim(stripslashes($_POST['subject'][$i])));
		$spl_val = explode(',', preg_replace(TB_OPTION_ID_FILTER, '', trim(stripslashes($_POST['supply'][$i]))));
