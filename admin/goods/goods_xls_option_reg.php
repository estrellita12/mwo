...
<div class="tbl_frm02">
	...
	<tr>
		<th>샘플파일 다운</th>
		<td><a href="<?php echo TB_LIB_URL; ?>/Excel/itemoptionexcel.zip" class="btn_small bx-blue"><i class="fa fa-download"></i> 상품옵션 일괄등록용 엑셀파일 다운로드</a></td>
	</tr>
	<tr>
		<th>파일 업로드</th>
...
function fitemexcel_submit(f)
{
	...
	f.action = tb_admin_url+"/goods.php?code=xls_option_reg_update";
	return true;
}
</script>
