...
<div id="snb">
	...
	<dl>
		...
		<?php echo printMenu2('s10', ADMIN_MENU3_06, TB_ADMIN_URL.'/seller.php?code=mail_select_form'); ?>
		<?php echo printMenu1('s20', '공급사 정산'); ?>
		<?php echo printMenu2('s20', ADMIN_MENU3_04, TB_ADMIN_URL.'/seller.php?code=pay'); ?>
		<?php echo printMenu2('s20', ADMIN_MENU3_08, TB_ADMIN_URL.'/seller.php?code=pay2'); ?>
		<?php echo printMenu2('s20', ADMIN_MENU3_05, TB_ADMIN_URL.'/seller.php?code=pay_history'); ?>
		<?php echo printMenu1('s20', '공급사 게시판'); ?>
		<?php echo printMenu2('s20', ADMIN_MENU3_07, 'https://mwo.kr/bbs/list.php?boardid=42'); ?>
	</dl>
	<?php }
	...
	<?php }
		...
		$goods1 = admRequest("shop_goods1", "and left(mb_id,3)='AP-' and use_aff = 0");
		$goods2 = admRequest("shop_goods2", "and left(mb_id,3)='AP-' and use_aff = 0");
	...
	<dl>
		...
		<?php echo printMenu2('g10', ADMIN_MENU5_18, TB_ADMIN_URL.'/goods.php?code=supply', $goods1); ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_24, TB_ADMIN_URL.'/goods.php?code=supply2', $goods2); ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_19, TB_ADMIN_URL.'/goods.php?code=userlist'); ?>
		...
		<?php echo printMenu2('g20', ADMIN_MENU5_06, TB_ADMIN_URL.'/goods.php?code=stock', $jaego1); ?>
		<?php echo printMenu2('g20', ADMIN_MENU5_07, TB_ADMIN_URL.'/goods.php?code=optstock', $jaego2); ?>
		<?php echo printMenu1('g30', '일괄처리'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_08, TB_ADMIN_URL.'/goods.php?code=xls_reg'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_09, TB_ADMIN_URL.'/goods.php?code=xls_option_reg'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_10, TB_ADMIN_URL.'/goods.php?code=xls_mod'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_11, TB_ADMIN_URL.'/goods.php?code=getprice'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_12, TB_ADMIN_URL.'/goods.php?code=getpoint'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_13, TB_ADMIN_URL.'/goods.php?code=getuse'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_14, TB_ADMIN_URL.'/goods.php?code=getmove'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_15, TB_ADMIN_URL.'/goods.php?code=getbrand'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_16, TB_ADMIN_URL.'/goods.php?code=getdelivery'); ?>
		<?php echo printMenu2('g30', ADMIN_MENU5_17, TB_ADMIN_URL.'/goods.php?code=getbuylevel'); ?>
		...
		<?php echo printMenu2('g60', ADMIN_MENU5_05, TB_ADMIN_URL.'/goods.php?code=price'); ?>
		<?php echo printMenu2('g60', ADMIN_MENU5_25, TB_ADMIN_URL.'/goods.php?code=popular_list'); ?>
		<?php echo printMenu2('g60', ADMIN_MENU5_26, TB_ADMIN_URL.'/goods.php?code=popular_rank'); ?>
	</dl>
	<?php }
        ...
        $sodr10 = admin_order_status_sum("where dan = 10 "); // 총 반품신청
        $sodr11 = admin_order_status_sum("where dan = 11 "); // 총 반품중
        $sodr12 = admin_order_status_sum("where dan = 12 "); // 총 교환신청
        $sodr13 = admin_order_status_sum("where dan = 13 "); // 총 교환중
	...
	<dl>
        ...
        <?php echo printMenu1('o20', '교환 관리'); ?>
        <?php echo printMenu2('o20', ADMIN_MENU6_15, TB_ADMIN_URL.'/order.php?code=12', $sodr12['cnt']); ?>
        <?php echo printMenu2('o20', ADMIN_MENU6_16, TB_ADMIN_URL.'/order.php?code=13', $sodr13['cnt']); ?>
        <?php echo printMenu2('o20', ADMIN_MENU6_11, TB_ADMIN_URL.'/order.php?code=8', $sodr8['cnt']); ?>
        <?php echo printMenu1('o30', '반품 관리'); ?>
        <?php echo printMenu2('o30', ADMIN_MENU6_13, TB_ADMIN_URL.'/order.php?code=10', $sodr10['cnt']); ?>
        <?php echo printMenu2('o30', ADMIN_MENU6_14, TB_ADMIN_URL.'/order.php?code=11', $sodr11['cnt']); ?>
        <?php echo printMenu2('o30', ADMIN_MENU6_10, TB_ADMIN_URL.'/order.php?code=7', $sodr7['cnt']); ?>
        <?php echo printMenu1('o40', '취소/환불 관리'); ?>
        <?php echo printMenu2('o40', ADMIN_MENU6_08, TB_ADMIN_URL.'/order.php?code=6', $sodr6['cnt']); ?>
        <?php echo printMenu2('o40', ADMIN_MENU6_09, TB_ADMIN_URL.'/order.php?code=9', $sodr9['cnt']); ?>
	...
	<dl>
		...
		<?php echo printMenu2('v20', ADMIN_MENU7_16, TB_ADMIN_URL.'/visit.php?code=seller'); ?>
	</dl>
	<?php }
