...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td><input type="text" name="cf_visit_del" value="<?php echo $config['cf_visit_del']; ?>" class="frm_input w50"> 일 이후 자동삭제</td>
		<th scope="row">상품 인기검색어 삭제</th>
		<td><input type="text" name="cf_popular_del" value="<?php echo $config['cf_popular_del']; ?>" class="frm_input w50"> 일 이후 자동삭제</td>
	</tr>
	<tr>
