...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td class="td_label">
			<input type="radio" name="de_card_test" value="0" id="de_card_test_1"<?php echo get_checked($default['de_card_test'], "0"); ?>>
			<label for="de_card_test_1">실결제</label>
			<input type="radio" name="de_card_test" value="1" id="de_card_test_2"<?php echo get_checked($default['de_card_test'], "1"); ?>>
	...
	<tr>
		...
		<td>
			<select name="de_pg_service" id="de_pg_service">
				...
				<?php echo option_selected("nicepay", $default['de_pg_service'], "나이스페이"); ?>
			</select>
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="de_tax_flag_use" value="1" id="de_tax_flag_use"<?php echo get_checked($default['de_tax_flag_use'], "1"); ?>>
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="de_taxsave_use" value="1" id="de_taxsave_use"<?php echo get_checked($default['de_taxsave_use'], "1"); ?>>
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="de_card_noint_use" value="1" id="de_card_noint_use"<?php echo get_checked($default['de_card_noint_use'], "1"); ?>>
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="de_easy_pay_use" value="1" id="de_easy_pay_use"<?php echo get_checked($default['de_easy_pay_use'], "1"); ?>>
...
<div class="pg_info_fld nicepay_info_fld">
	...
	<div class="tbl_frm01">
		...
		<tr>
			...
			<td>
				<input type="text" name="de_nicepay_mid" value="<?php echo $default['de_nicepay_mid']; ?>" id="de_nicepay_mid" class="frm_input" size="10">
				<a href="https://www.nicepay.co.kr/apply/request/partnerReq.do?reqCd=hosting&partnerId=PG00000078" target="_blank" class="btn_small blue">나이스페이 서비스신청하기</a>
		...
		<tr>
			...
			<td>
				<input type="text" name="de_nicepay_key" value="<?php echo $default['de_nicepay_key']; ?>" id="de_nicepay_key" class="frm_input" size="50">
		...
		<tr>
			...
			<td>
				<input type="text" name="de_nicepay_pwd" value="<?php echo $default['de_nicepay_pwd']; ?>" id="de_nicepay_pwd" class="frm_input" size="10">
	...
	<div class="tbl_frm01">
		...
		<tr>
			...
			<td>
				...
				<a href="https://admin8.kcp.co.kr/hp.HomePageAction.do?cmd=apply&host_id=투비웹" target="_blank" class="btn_small blue">NHN KCP서비스신청하기</a>
	...
	<div class="tbl_frm01">
		...
		<tr>
			...
			<td>
				...
				<a href="https://www.inicis.com/pg-hosting?cd=hostinglanding&product=tubeweb&settlement=N" target="_blank" class="btn_small blue">KG이니시스 서비스신청하기</a>
...
if($default['de_iche_use'] || $default['de_vbank_use'] || $default['de_hp_use'] || $default['de_card_use']) {
	...
	// 나이스페이의 경우 log 디렉토리 체크
	if($default['de_pg_service'] == 'nicepay') {
        $log_path = TB_SHOP_PATH.'/nicepay/log';

        if(!is_dir($log_path)) {
            echo '<script>'.PHP_EOL;
            echo 'alert("'.str_replace(TB_PATH.'/', '', TB_SHOP_PATH).'/nicepay 폴더 안에 log 폴더를 생성하신 후 쓰기권한을 부여해 주십시오.\n> mkdir log\n> chmod 707 log");'.PHP_EOL;
            echo '</script>'.PHP_EOL;
        } else {
            if(!is_writable($log_path)) {
                echo '<script>'.PHP_EOL;
