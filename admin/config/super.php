...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			...
			<a href="<?php echo TB_ADMIN_URL; ?>/member/member_point_req.php?mb_id=<?php echo $super['id']; ?>" onclick="win_open(this,'pop_point_req','450','450','no');return false" class="btn_small grey marl10">강제적립</a>
		</td>
	</tr>
	<tr>
