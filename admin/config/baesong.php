...
<div class="tbl_frm01">
	...
	<tbody>
	<tr>
		<th scope="row">본사 내용으로 노출</th>
		<td>
			<label><input type="checkbox" name="baesong_adm_cont_use" value="1"<?php echo get_checked($config['baesong_adm_cont_use'], "1"); ?>> 사용함</label>
			<?php echo help('공급사 및 가맹점의 상품도 <strong class="fc_red">본사 배송/교환/반품안내</strong> 내용으로 노출됩니다.<br>사용함에 체크하지 않으면 각각 개별적으로 설정된 내용으로 노출되며 내용이 입력되지 않았다면 노출되지 않습니다.<br>"배송/교환/반품" 정책은 일반적으로 판매자마다 모두 다르기때문에 각각 설정하시길 권장드립니다.<br>"배송/교환/반품" 정책은 공급사 및 가맹점의 관리자페이지에서 개별적으로 설정 가능합니다.'); ?>
		</td>
	</tr>
	<tr>
