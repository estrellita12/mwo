...
<form name="fplist" id="fplist" method="post" action="./partner/pt_plistupdate.php" onsubmit="return fplist_submit(this);">
...
<div class="tbl_head02">
	...
	<tr class="rows">
		...
		<th scope="col" class="th_bg"><?php echo subject_sort_link('vi_today',$q2); ?>오늘</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('vi_yesterday',$q2); ?>어제</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('vi_max',$q2); ?>최대</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('vi_sum',$q2); ?>전체</a></th>
	</tr>
	</thead>
	<?php
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><a href="<?php echo TB_ADMIN_URL; ?>/partner/pt_category.php?mb_id=<?php echo $row['id']; ?>" onclick="win_open(this,'pop_category','900','687','yes');return false;" class="btn_small bx-white">카테고리</a></td>
	</tr>
	<?php
	}
	if($i==0)
...
<form name="fplist2" id="fplist2" method="post" action="./partner/pt_ppayupdate.php" autocomplete="off">
<input type="hidden" name="q1" value="<?php echo $q1; ?>">
<input type="hidden" name="page" value="<?php echo $page; ?>">
