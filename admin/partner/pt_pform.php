...
<section id="anc_pbasic">
	...
	<div class="tbl_frm01">
		...
		<tbody>
		<tr>
			<th scope="row" rowspan="4">상품 판매수수료</th>
			<td>
				<input type="checkbox" name="pf_sale_use" value="1" id="pf_sale_use"<?php echo get_checked($config['pf_sale_use'], "1"); ?>>
		...
		<tr>
			<td class="bo_label">
				<label><input type="radio" name="pf_sale_target1" value="0"<?php echo get_checked($config['pf_sale_target1'], "0"); ?>> 주문자가 회원일 경우 <strong class="fc_red">주문당시 가맹점몰에 판매수수료가 적립</strong></label><br>
				<label><input type="radio" name="pf_sale_target1" value="1"<?php echo get_checked($config['pf_sale_target1'], "1"); ?>> 주문자가 회원일 경우 <strong class="fc_red">현재 추천인에게 판매수수료가 적립</strong></label>
				<?php echo help('비회원의 경우 무조건 주문당시 가맹점몰에 판매수수료가 적립됩니다.'); ?>
			</td>
		</tr>
		<tr>
			<td class="bo_label">
				<label><input type="radio" name="pf_sale_target2" value="0"<?php echo get_checked($config['pf_sale_target2'], "0"); ?>> 주문자가 가맹점일 경우 <strong class="fc_red">주문당시 가맹점몰에 판매수수료가 적립</strong></label><br>
				<label><input type="radio" name="pf_sale_target2" value="1"<?php echo get_checked($config['pf_sale_target2'], "1"); ?>> 주문자가 가맹점일 경우 <strong class="fc_red">현재 추천인에게 판매수수료가 적립</strong></label><br>
				<label><input type="radio" name="pf_sale_target2" value="2"<?php echo get_checked($config['pf_sale_target2'], "2"); ?>> 주문자가 가맹점일 경우 <strong class="fc_red">가맹점 자신에게 판매수수료가 적립</strong><span>(가맹점 자신에게 혜택)</span></label>
			</td>
		</tr>
		<tr>
			<th scope="row">분양 추천수수료</th>
			<td>
				<input type="checkbox" name="pf_anew_use" value="1" id="pf_anew_use"<?php echo get_checked($config['pf_anew_use'], "1"); ?>>
		...
		<tr>
			...
			<td>
				<input type="checkbox" name="pf_visit_use" value="1" id="pf_visit_use"<?php echo get_checked($config['pf_visit_use'], "1"); ?>>
...
<section id="anc_panew">
	...
	<div class="tbl_frm01">
		...
		<tr>
			...
			<td>
				<input type="checkbox" name="partner_reg_yes" value="1" id="partner_reg_yes"<?php echo get_checked($config['partner_reg_yes'], "1"); ?>>
		...
		<tr>
			...
			<td>
				<input type="checkbox" name="pf_payment_yes" value="1" id="pf_payment_yes"<?php echo get_checked($config['pf_payment_yes'], "1"); ?>>
		...
		<tr>
			...
			<td>
				<input type="text" name="pf_basedomain" value="<?php echo $config['pf_basedomain']; ?>" id="pf_basedomain" required class="required frm_input" size="100">
