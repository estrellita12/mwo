...
for($i=2; $row=sql_fetch_array($result); $i++)
{
	...
	// 오늘
	$and1 = " and left(od_time,10) between '".TB_TIME_YMD."' and '".TB_TIME_YMD."' ";
	$row1 = partner_order_status_sum($row['id'], $and1);

	// 어제
	$yesterday = date("Y-m-d", strtotime("-1 day"));
	$and2 = " and left(od_time,10) between '".$yesterday."' and '".TB_TIME_YMD."' ";
	$row2 = partner_order_status_sum($row['id'], $and2);

	// 일주일
	$weekday = date("Y-m-d", strtotime("-7 day"));
	$and3 = " and left(od_time,10) between '".$weekday."' and '".TB_TIME_YMD."' ";
	...
	$and5 = " and left(od_time,10) between '".$month3."' and '".TB_TIME_YMD."' ";
