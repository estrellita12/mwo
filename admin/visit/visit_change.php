...
$sql = " select COUNT(*) as cnt
		   from shop_order
		  where dan = 8
		    and left(change_date,7) = '$search_date' ";
$row = sql_fetch($sql);
...
<div class="local_ov mart20">
	<strong>총 교환건수 : <?php echo number_format($sum_count); ?>건</strong>
</div>
