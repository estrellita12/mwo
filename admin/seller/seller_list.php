...
$sql = " select a.*,b.grade, b.name, b.email $sql_common $sql_search $sql_order limit $from_record, $rows ";
...
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col"><?php echo subject_sort_link('a.app_time',$q2); ?>승인일시</a></th>
	</tr>
	</thead>
	<?php
