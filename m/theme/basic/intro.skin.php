...
<div class="mb_login">
	<section class="login_fs">
        ...
        <h2 class="log_tit"><strong>MWO 파트너 로그인</strong></h2>
		<p class="mart15">
		...
		<!-- <p class="mart3"><a href="<?php echo TB_MBBS_URL; ?>/register.php" class="btn_medium bx-white wfull">공급사 회원가입</a></p> -->
        <br>
        <li>아이디/비밀번호를 분실하신 경우,담당 영업사원에게 문의하시기 바랍니다.</li>
        <li>공급사 회원가입은 PC에서만 가능합니다..</li>
