...
<script src="<?php echo TB_JS_URL; ?>/kakaolink.js"></script>
<script>
...
<div class="sp_wrap">
	...
	<div id="v1">
		...
		<div class="sp_vbox img_fix2 iframe_cont">
	...
	<div id="v4" style="display:none;">
		<div class="sp_vbox img_fix2">
			<?php echo conv_content(get_baesong_cont($gs['mb_id']), 1); ?>
		</div>
	</div>
</div>
</form>
