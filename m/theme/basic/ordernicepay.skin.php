...
<div id="sod_fin">
	...
	require_once(TB_MSHOP_PATH.'/nicepay/orderform.1.php');
	?>

	<form id="forderform" name="forderform" method="post" target="_self" action="<?php echo $order_action_url; ?>" accept-charset="euc-kr">
	...
	require_once(TB_MSHOP_PATH.'/nicepay/orderform.2.php');
	?>
...
<script>
var settle_case = "<?php echo $od['paymethod']; ?>";
...
{
    var tot_price = parseInt(f.Amt.value);
