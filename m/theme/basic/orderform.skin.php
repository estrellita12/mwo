	...
	<section id="sod_frm_taker">
		...
		<div class="odf_tbl">
			...
			<tr>
				...
				<td>
					<input type="radio" name="ad_sel_addr" value="1" id="sel_addr1" class="css-checkbox">
					<label for="sel_addr1" class="css-label">주문자와 동일</label><br>
					<input type="radio" name="ad_sel_addr" value="2" id="sel_addr2" class="css-checkbox">
					<label for="sel_addr2" class="css-label">신규배송지</label>
					<?php if($is_member) { ?>
					<br><input type="radio" name="ad_sel_addr" value="3" id="sel_addr3" class="css-checkbox">
