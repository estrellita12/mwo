...
if($_SESSION['ss_hash_token'] != TB_HASH_TOKEN) {
    alert('잘못된 접근입니다.', TB_MURL);
}
...
if($w == '') {
    goto_url(TB_MBBS_URL.'/register_result.php');
} else if($w == 'u') {
	...
	<title>회원정보수정</title>
	<body>
	<form name="fregisterupdate" method="post" action="'.TB_MBBS_URL.'/register_form.php">
